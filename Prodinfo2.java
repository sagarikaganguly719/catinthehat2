...
public class Prodinfo2 extends javax.swing.JFrame 
{
static String x,y,z;
    
    public Prodinfo2(String s,String t,String r)
    {
        initComponents();
        x=s;
        y=t;
        ...
        jLabel2.setText(y);
        jLabel3.setText(z);
        setTitle("Product Information Print");
        setVisible(true);
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Prodinfo2(x,y,z).setVisible(true);
            }
        });
    }
